...
# pdf("SA494B-freq.pdf", width=10, height=4)
...
if (type == "freq") levelplot(ef, xlab="Variant", las=2, ylab="Samples", main=graphtitle, col.regions=rgb.palette(10), cuts=10, at=seq(0.2,1.0,0.1), aspect="fill", scales=list(x=list(rot=90, cex=0.3),y=list(cex=0.5)) )

if (type == "reads") levelplot(ef, xlab="Variant", las=2, ylab="Samples", main=graphtitle, col.regions=rgb.palette(200), cuts=200, at=seq(20,5020,200), aspect="fill", scales=list(x=list(rot=90, cex=0.3),y=list(cex=0.5)) )
